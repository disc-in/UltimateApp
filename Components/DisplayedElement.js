...
class DisplayedElement extends React.Component{
	...
	case "defense":
	    return(
		<Animated.Text style={[styles.defense, {top: this.state.currentPosition.y},  {left:this.state.currentPosition.x}]} key={this.props.key}>{this.props.number}</Animated.Text>
	    );
            
	case "offense":
	    return(
		<Animated.Text style={[styles.offense, {top: this.state.currentPosition.y},  {left:this.state.currentPosition.x}]} key={this.props.key}>{this.props.number}</Animated.Text>
	    );
            
	case "disc":
	    return(
		<Animated.View style={[styles.disc, {top: this.state.currentPosition.y},  {left:this.state.currentPosition.x}]} key={this.props.key}/>
	    );
            
	case "triangle":
	    return(
		<Animated.View style={[styles.triangle, {top: this.state.currentPosition.y},  {left:this.state.currentPosition.x}]} key={this.props.key}/>
	    );
