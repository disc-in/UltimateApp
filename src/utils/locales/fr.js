...
export default {
  ...
  drillEditor: {
    ...
    drillManager: {
      ...
      saveModifications: 'Voulez-vous sauvegarder les modifications ?',
      saveModifications2: 'L\'exercice "',
      saveModifications3: '" a été modifié.\n\nSouhaitez-vous conserver ces modifications ?',
      saveAndOpen: 'Sauvegarder puis ouvrir',
      openWithoutSaving: 'Ouvrir sans sauvegarder',
      saveAndCreate: 'Sauvegarder puis créer',
      createWithoutSaving: 'Créer sans sauvegarder',
