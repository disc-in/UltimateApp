...
const ids = ["triangle", "triangle", "triangle", "triangle", "triangle", "triangle", "triangle", "triangle", "offense", "offense", "offense", "offense", "offense", "disc"];
...
export default drillSquare = {positions, ids, texts}
