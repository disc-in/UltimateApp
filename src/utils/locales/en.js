...
export default {
  ...
  drillEditor: {
    ...
    drillManager: {
      ...
      saveModifications: 'Do you want to save the modifications?',
      saveModifications2: 'The drill "',
      saveModifications3: '" has been modified.\n\nDo you want to save these modifications?',
