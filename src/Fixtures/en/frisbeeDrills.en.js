...
const strenght1 = {
  ...
  type: DrillTypes.FITNESS,
  author: '',
  title: 'Strenght Upper Body',
  image: 'https://zupimages.net/up/20/19/kj0f.jpg',
  description: ' ',
  minimalPlayersNumber: 1,
  equipmentLabel: EquipmentLabels.FULL,
  equipment: 'Tow bar - Kettlebell',
  durationInMinutes: 25,
  intensity: Intensities.HIGH,
  goals: [FitnessGoals.UPPER],
  seasonTiming: SeasonTimings.OFF_SEASON,
  level: Levels.INTERMEDIATE,
  steps: [
    {
...
const strenght2 = {
  ...
  minimalPlayersNumber: 1,
  equipmentLabel: EquipmentLabels.FULL,
  equipment: 'Tow bar - Kettlebell -Banded',
  durationInMinutes: 25,
  intensity: Intensities.HIGH,
  goals: [FitnessGoals.UPPER],
  seasonTiming: SeasonTimings.OFF_SEASON,
...
const agility3 = {
  ...
  durationInMinutes: 30,
  intensity: Intensities.MODERATE,
  goals: [FitnessGoals.LEGS, FitnessGoals.FULL_BODY],
  seasonTiming: SeasonTimings.OFF_SEASON,
  level: Levels.INTERMEDIATE,
  steps: [
    {
...
const strenght16 = {
  ...
  durationInMinutes: 30,
  intensity: Intensities.HIGH,
  goals: [FitnessGoals.UPPER, FitnessGoals.FULL_BODY],
