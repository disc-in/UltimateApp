...
class DrillCuts extends React.Component{
    ...
    */
	...
	this.coneSize = this.playerRadius * 5 / 16;
		...
		console.log("stepId: " + stepId);                 
		    ...
		    console.log("\telemId: " + elemId);
                    ...
                    if(this.props.drill.positions[stepId+1][elemId] !== null && this.props.drill.positions[stepId+1][elemId] !== undefined){
	...
	return(
		...
		{this.cuts.length >= this.props.currentStep && this.cuts[this.props.currentStep] != undefined? this.cuts[this.props.currentStep].map(this._displayCut):undefined}
            </View>
	);
    }
}                         
