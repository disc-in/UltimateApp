...
class DrillMenageATrois{
	...
	this.positions[0] = p1Positions;
	this.positions[1] = p2Positions;
	this.positions[2] = p3Positions;
	this.positions[3] = discPositions;
