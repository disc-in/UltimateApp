...
const ironman1 = {
  ...
  image: 'https://zupimages.net/up/20/19/kj0f.jpg',
  description:
    'At the end of a contest, at the end of a game or after five turnovers, you want to dominate the field. This program is based on a mix between (lactic) resistance, VMA and still a lot of speed and explosiveness.',
  minimalPlayersNumber: 1,
  equipmentLabel: EquipmentLabels.NONE,
  equipment: 'None',
  ...
  steps: [
    ...
    },
    {
      ...
      repetition: '8*(30/30)',
      rest: '',
      instruction: 'VMA (3*8*(30/30)): 100% of VMA speed. 3 minutes of recuperation between the series',
    },
    {
      id: 3,
      title: 'Rest',
...
const ironman2 = {
  ...
  image: 'https://zupimages.net/up/20/19/kj0f.jpg',
  description:
    "Intense heat. You have to be prepared to withstand a very high effort and high speed. 3 series of 4 race repetitions over 1'30 with the maximum distance in 1'30. 3'30 recovery between each repetition. 7'30 of recovery between the two series: possibility of throwing.",
  minimalPlayersNumber: 1,
  equipmentLabel: EquipmentLabels.NONE,
  equipment: 'None',
...
const fitnessWeek1 = {
  ...
  drills: [ironman1, flashTeam1, machines1],
};
...
const fitnessWeek2 = {
  ...
  drills: [ironman2, flashTeam2, machines2],
};
