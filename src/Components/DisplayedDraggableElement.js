...
class DisplayedDraggableElement extends React.Component {
	...
	this.state.currentPosition.y.addListener(({value}) => this._value = value);
		...
		console.log("pos: " + this.state.currentPosition.x + "/"  + this.state.currentPosition.x + ", offset: " + this._val.x + "/" + this._val.y);
	    ...
	    // Called when a move is made
            onPanResponderMove: Animated.event([
                null, { dx: this.state.currentPosition.x, dy: this.state.currentPosition.y }
            ]),

	    onPanResponderRelease: (evt, gesturestate) => {this.props.onMoveEnd(this.state.currentPosition.x._value, this.state.currentPosition.y._value);}
        });
    }
